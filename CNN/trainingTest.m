...
for i = 1:trainNum
    ...
    featIm = localEnergyComputation(ewtc);
...
testFeatures = reshape(applyFilterBank(test,Bw,Bt),[512*512 featureSize]);
...
GroundTruths = 4/255.*imread('../Outex_SS_00000/ground_truth.ras');
unique(GroundTruths)
